 ...
 */
public class testIntegrationRegisterRetailActivity extends ActivityInstrumentationTestCase2<LoginActivity> {
    private Solo solo;

    public testIntegrationRegisterRetailActivity(){
        super(LoginActivity.class);
    }
    public EditText usrname, pw0, pw1, firstn, midn, lastn;
    ...
    protected void setUp() throws Exception
    {
        ...
        Button reg = (Button) solo.getView(R.id.button_01);
     ...
     */
    @MediumTest
    public void testRegisterRetailAllNullFields() {

        Button register = (Button) solo.getView(R.id.button_03);
        solo.clickOnView(register);


        solo.assertCurrentActivity("", RegisterRetailActivity.class);
    }
     ...
     */
    @MediumTest
    public void testRegisterRetailAllFieldsFilled() {

        Random r = new Random();
        r.setSeed(Time.SECOND);
        int extra = Math.abs(r.nextInt() - 2);
